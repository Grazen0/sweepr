...
namespace term_manip
{
    ...
    namespace color
    {
        ...
        const char FG_BRIGHT_BLACK[] = "\033[90m";
        const char FG_BRIGHT_RED[] = "\033[91m";
        const char FG_BRIGHT_GREEN[] = "\033[92m";
        const char FG_BRIGHT_YELLOW[] = "\033[93m";
        const char FG_BRIGHT_BLUE[] = "\033[94m";
        const char FG_BRIGHT_MAGENTA[] = "\033[95m";
        const char FG_BRIGHT_CYAN[] = "\033[96m";
